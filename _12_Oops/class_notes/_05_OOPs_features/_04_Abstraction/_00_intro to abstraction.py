...
with a large code-base where keeping all classes in your mind is difficult or not possible.
...
# Driver code
# p = Polygon()
# p.noofsides  TypeError: Can't instantiate abstract class Polygon with abstract method noofsides
...
In this case, the Python class management is used to recognize PluginImplementation as implementing the 
abstract PluginBase.
...
A side-effect of using direct subclassing is, it is possible to find all the implementations of your plugin 
