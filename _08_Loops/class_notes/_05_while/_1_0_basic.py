...
We generally use this loop when we don't know the number of times
...
print("--------------")
x = 1
while x <= 5:   # for loop have range(10)
    print(x)
...
num2 = int(input("Enter number2 :")) # 120
    #BEHAVIOR
while num1 <= num2:
    print(num1, end=',')
    num1 += 1
