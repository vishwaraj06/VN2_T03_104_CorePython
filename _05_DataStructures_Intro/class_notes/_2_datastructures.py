# indexing: To retrieve specific element through using index position
...
print("Get partial name : ", name[2:6])  # slicing  (start value to end-1 value)
