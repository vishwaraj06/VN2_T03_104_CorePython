...
Integer Whole Fractional Real  Imaginary   ==> Data Types     ===> int float boolean, str
...
Sets, Sequences, Matrices   ==>  String, List, Tuple, Dictionary, Set
